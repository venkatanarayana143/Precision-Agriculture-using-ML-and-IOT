...
@login_required
def crop_recommend():
    title = 'Precision Agriculture - Crop Recommendation'
    return render_template('crop.html', title=title)

@ app.route('/fertilizer')
@login_required
def fertilizer_recommendation():
    title = 'Precision Agriculture - Fertilizer Suggestion'
    return render_template('fertilizer.html', title=title)

@app.route('/disease-predict', methods=['GET', 'POST'])
@login_required
def disease_predictn():
    title = 'Precision Agriculture - Disease Detection'
...
#crop disease predction function
